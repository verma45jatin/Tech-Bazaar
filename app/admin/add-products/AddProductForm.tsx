            ...
            <div className="w-full flex flex-col flex-wrap gap-4">
                <div>
                    ...
                    <div className="text-sm">
                        You must upload an image for each of the color selected otherwise ypur color selection will be ignored
                    </div>
                </div>
                <div className="grid, grid-cols-2 gap-3">
                    {colors.map((item,index)=>{
                        return(
                           <SelectColor key={index} item={item} addImageToState={addImageToState}
